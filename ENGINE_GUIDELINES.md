...
- ❌ the attempt actions have to operate on specific cards and stacks, like choosse the specific vaccine in your hand and defining the specific organ to heal, so adjust the functions to do so (maybe add some kind of indexing in the deck?) -> DONT KNOW HOW TO IMPLEMENT IT
